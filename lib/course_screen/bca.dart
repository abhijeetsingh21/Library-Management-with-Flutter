...
class BcaScreen extends StatefulWidget {
  static const String id = 'BcaScreen';

  @override
  State<BcaScreen> createState() => _BcaScreenState();
}

class _BcaScreenState extends State<BcaScreen> {
                ...
                children: [
                  Padding(
                    ...
                    child: GestureDetector(
                      child: Container(
                        ...
                        child: const Center(child: Icon(Icons.upload,color: Colors.white,)),
                      ),
                      onTap: () => uploadFile(),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () => Navigator.pushNamed(context, 'BcaChatScreen'),
                    ),
                  ),
                ],
              ),
